<template>
  <div id="container" class="outer container">
    ...
    <section class="article">
      <p>For the purposes of this demonstration, I need to demonstrate assessing and conforming a page to a standard of accessibility. I've decided to create a page with data (classes) and a log-in feature. Additionally I wrote a backend api to administer the data, but at this time it is not wired up with a front end (since it would not be publically visible).</p>
